...
public class ServiceController {
    ...
    @PutMapping("/api/admin/services/restore/{serviceId}")
    public ResponseEntity<ServiceAdminResponse> restoreService(@PathVariable Long serviceId) {
        return ResponseEntity.status(HttpStatus.OK).body(service.activateService(serviceId));
    }
}
