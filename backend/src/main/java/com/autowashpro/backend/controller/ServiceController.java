...
public class ServiceController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Service>> createService(@RequestBody Service newService) {
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.created(service.create(newService)));
    }

    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<Service>> updateService(@PathVariable Long id, @RequestBody Service updatedService) {
        return ResponseEntity.ok(ApiResponse.success(service.update(id, updatedService)));
    }
    ...
    public ResponseEntity<ApiResponse<Service>> toggleActive(@PathVariable Long id) {
