                    ...
                    <article>
                        ...
                        <div className="blog-detail__body">
                            ...
                            <div className="blog-detail__callout">
                                <PhoneOutlined style={{ marginRight: 6, color: '#e53e3e' }} /> <strong>Hotline đặt lịch dịch vụ tại nhà:</strong> 07 64 64 64 16
                                <br />
                                <EnvironmentOutlined style={{ marginRight: 6, color: '#3182ce' }} /> <strong>Địa chỉ trung tâm:</strong> Số 1A Đường Phú Thuận, phường Phú Thuận, Quận 7, TP. HCM
                            </div>
                        </div>
                    </article>
