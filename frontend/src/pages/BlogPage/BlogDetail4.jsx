                        ...
                        <div className="blog-detail__body">
                            ...
                            <ul>
                             ...
                             <div className="blog-detail__callout">
                                ...
                                <br />
                                <EnvironmentOutlined style={{ marginRight: 6, color: '#3182ce' }} /> <strong>Địa chỉ:</strong> Số 1A Đường Phú Thuận, phường Phú Thuận, Quận 7, TP. HCM (Gần Phú Mỹ Hưng)
                                <br />
                                <PhoneOutlined style={{ marginRight: 6, color: '#e53e3e' }} /> <strong>Hotline trung tâm:</strong> 0784 7676 79 / 0911 811 247
                                <br />
                                <PhoneOutlined style={{ marginRight: 6, color: '#e53e3e' }} /> <strong>Hotline dịch vụ tại nhà:</strong> 07 64 64 64 16
                             </div>
