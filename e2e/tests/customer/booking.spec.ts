...
test.describe.serial('@p0 customer booking wizard', () => {
  test('TC-CU13 completes all four basic booking steps with auto assignment', async ({
    customerPage,
    customerApi,
  }) => {
  ...
  test('TC-CU14 staff list appears only after slot selection and selected staff is saved', async ({
    customerPage,
    customerApi,
  }) => {
